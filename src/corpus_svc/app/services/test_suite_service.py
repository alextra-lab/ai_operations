...
class TestSuiteService:
    ...
    async def create_test_suite(
        ...
        from ..schemas.test_suite import TestQuestionCreate

        questions = []
        if test_suite_create.questions:
            for question_data in test_suite_create.questions:
                # Convert TestQuestionBase to TestQuestionCreate
                question_create = TestQuestionCreate(**question_data.model_dump())
    ...
    async def update_test_suite(
        ...
        if test_suite_update.collection_ids is not None:
            ...
            params["collection_ids"] = [str(cid) for cid in test_suite_update.collection_ids]  # type: ignore[assignment]

        if test_suite_update.k is not None:
            update_fields.append("k = :k")
            params["k"] = test_suite_update.k  # type: ignore[assignment]
        ...
        params["updated_at"] = datetime.utcnow()  # type: ignore[assignment]
