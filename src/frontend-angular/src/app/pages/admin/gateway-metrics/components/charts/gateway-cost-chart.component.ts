/**
 * Gateway Cost Chart Component
 *
 * Area chart showing cost trends for Gateway requests using lazy-loaded Chart.js.
...
@Component({
  selector: 'app-gateway-cost-chart',
  standalone: true,
  ...
  template: `
    <div class="chart-container">
      ...
      <canvas
        #chartCanvas
        [hidden]="isLoading"
        [attr.aria-label]="'Gateway cost over time chart'"
      >
      </canvas>
    </div>
  `,
...
export class GatewayCostChartComponent
  implements AfterViewInit, OnChanges, OnDestroy
{
  ...
  private updateChart(): void {
    ...
    this.chart.data.datasets[0].data = cumulativeValues;
    this.chart.update();
  }
}
