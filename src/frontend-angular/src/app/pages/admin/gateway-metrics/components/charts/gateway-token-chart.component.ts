/**
 * Gateway Token Usage Chart Component
 *
 * Bar chart showing token usage trends for Gateway requests using lazy-loaded Chart.js.
...
@Component({
  selector: 'app-gateway-token-chart',
  standalone: true,
  ...
  template: `
    <div class="chart-container">
      ...
      <canvas
        #chartCanvas
        [hidden]="isLoading"
        [attr.aria-label]="'Gateway token usage over time chart'"
      >
      </canvas>
    </div>
  `,
...
export class GatewayTokenChartComponent
